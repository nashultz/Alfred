...
from alfred import utils, checks

from alfred.exts import pokemon


class Trade:

    icon_url = ("https://raw.githubusercontent.com/FoglyOgly/Alfred/"
    ...
    async def accept_offer(self, offer_id):
        ...
        for offerid in self.offers.keys():
            if offerid != offer_id:
                ...
                try:
                    await reject.send((
                        "Alfred... {} accepted a competing offer for their {}."
    ...
    async def withdraw_offer(self, offer_id):
        ...
        await self.lister.send(
            "Alfred... {} withdrew their trade offer of {}.".format(
    ...
    async def reject_offer(self, offer_id):
        ...
        await trader.send(
            "Alfred... {} rejected your offer for their {}.".format(
    ...
    async def cancel_trade(self):
        ...
        for offerid in self.offers:
            ...
            await reject.send(
                "Alfred... {} canceled their trade offer of {}".format(
                    self.lister.display_name, offered_pokemon))
